      ...
      <article className="rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur-sm p-6 md:p-8 transition-shadow shadow-[0_6px_18px_rgba(0,0,0,0.18)] hover:shadow-[0_14px_40px_rgba(0,0,0,0.28)]">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-neutral-200/90">
              В разделе — полный путь сдачи квартиры: цена, подготовка, маркетинг, показы, переговоры
        и сопровождение договора аренды. Внутри вас ждут этапы, чек-лист собственника,
        рекомендации по снижению рисков, проверке арендаторов и прозрачной передаче квартиры.
            </p>
          </div>
          <div className="shrink-0">
