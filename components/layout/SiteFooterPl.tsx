      ...
      <Container>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-sm text-neutral-200/80">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li><a href="/privacy" className="hover:text-white">Polityka prywatności</a></li>
        ...
        <div className="mt-8 text-[13px] leading-relaxed text-neutral-200/75">
          ...
          <div>Adres korespondencyjny: Złota 75A/7, 00-819 Warszawa</div>
        </div>
        <div className="mt-10 text-xs text-neutral-200/60">© {new Date().getFullYear()} SERPAKOWSKI Nieruchomości. Wszelkie prawa zastrzeżone.</div>
      </Container>
    </footer>
  );
}
